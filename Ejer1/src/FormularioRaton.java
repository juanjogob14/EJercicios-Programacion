...
public class FormularioRaton extends JFrame {
    ...
    private class gestorRaton extends MouseAdapter {
        ...
        public void mouseMoved(MouseEvent e) {
            ...
            if(e.getSource() != btnDerecho && e.getSource() != btnIzquierdo){
                FormularioRaton.this.setTitle(String.format("Posicion X: %d Y: %d", e.getX(), e.getY()));
                coordX = e.getX();
                coordY = e.getY();
            }else{
                FormularioRaton.this.setTitle(String.format("Posicion X: %d Y: %d", e.getX()+coordX, e.getY()+coordY));
            }
